Feature: Login fuctionality test on Wikipedia page

  Scenario Outline: Validate login functionality in <browser> browser
    Given I open the website "https://pl.wikipedia.org/wiki/Wikipedia:Strona_g%C5%82%C3%B3wna" on specific "<browser>"
